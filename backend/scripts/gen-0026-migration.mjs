...
const rulesBlock =
  ...
  `-- Embedded in 0001_bootstrap.sql after category rows so category_id FKs resolve.\n\n` +
...
console.log("Updated category_rule_global inserts in", bootPath, "rows", uniq.length);
