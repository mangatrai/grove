...
- `PATCH /gdrive/settings` — owner only. Body `{ backupFrequencyHours, backupRetentionCount }` (frequency **0, 12, 24, 48, 72, or 168**; retention **1–30**). **404** `GDRIVE_NOT_CONFIGURED` if Drive is not connected. **200** echoes saved values.
