...
- docs/CHANGE_HISTORY.md (CR / UX / fixes — e.g. **UX-013** + **`GitHub:`** issue links, **UX-012**, **UX-011**, **CR-044**, **CR-043**, **CR-042**, **CR-041**)
- GitHub issues (optional cross-check): `https://github.com/mangatrai/household-finance-app/issues`
