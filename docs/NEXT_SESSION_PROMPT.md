...
- docs/CHANGE_HISTORY.md (CR / UX / fixes — e.g. **CR-041**, **CR-040**, **CR-039**, **CR-028**, **DOC-011**, **UX-009**, **FIX-006**–**FIX-008**)
...
1) Summarize the current state in 8-12 bullets. Cover: migrations through **`0021`** (incl. **`0018`** employer ref, **`0019`**–**`0020`** profile/membership, **`0021`** token-version session invalidation); **`PATCH /household/settings`** vs **`PATCH /household/profile`** (**CR-040**); auth/session invalidation behavior (**CR-041**); **`/transactions`** (**FIX-005**); **Needs review** + **CR-025**; **payslips** + **unified Import** (**CR-028**: **`ibm_pay_contributions_pdf`**, **`import_file_id`**, payslip-only canonicalize; **CR-041** multi-employer selection guardrail); **import** / **D-014** per **CHECKPOINT**.
