...
- **Environment / AI:** See [`ENVIRONMENT_VARIABLES.md`](ENVIRONMENT_VARIABLES.md) for `AI_CATEGORY_*`, `OPENAI_*`, transfer thresholds, and DB path behavior.
...
- AI categorization: optional; AI_CATEGORY_ENABLED + OPENAI_API_KEY
```
